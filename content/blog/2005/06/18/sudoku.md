...
"**Sudoku** est un puzzle à chiffre. Le but du jeu est de remplir la grille avec des chiffres allant de 1 à 9, en partant de certains chiffres déjà disposés dans la grille. La grille est généralement composée de régions de neuf carrés 3×3 formant une grille 9×9 (voir l'exemple ci-dessus). Chaque ligne, colonne et région ne doit contenir qu'une fois chaque chiffre. Le remplissage de la grille demande de la patience et une certaine logique. " ([Wikipedia](http://fr.wikipedia.org/wiki/Sudoku)).
